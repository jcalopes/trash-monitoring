...
namespace TrashTalker
{
    public static class Config
    {
        ...
        public const string GOOGLE_API_KEY = "api-key";
        ...
        public const string ARDUINO_CLIENT_ID = "arduino-client-id";
        public const string ARDUINO_CLIENT_SECRET = "arduino-secret";
